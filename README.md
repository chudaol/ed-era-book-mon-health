...
# Основи здоров'я (Спеціалізовані НЗ)
...
Також зміст програми можна відкрити безпосередньо на сторінці <a href="http://mon-health.ed-era.com/zmist.html">«Зміст програми»</a>.
...
- Якщо у вас є побажання до всієї програми, а не до конкретного розділу, залиште свій коментар на сторінці <a href="http://mon-health.ed-era.com/zmist.html">«Зміст програми»</a>.
